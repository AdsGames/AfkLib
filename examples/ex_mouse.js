...
(function() {
 var loadPackage = function(metadata) {
  ...
  var PACKAGE_NAME = "bin/ex_mouse.data";
  var REMOTE_PACKAGE_BASE = "ex_mouse.data";
  ...
  function runWithFS() {
   ...
   function processPackageData(arrayBuffer) {
    ...
    Module["removeRunDependency"]("datafile_bin/ex_mouse.data");
   }
   Module["addRunDependency"]("datafile_bin/ex_mouse.data");
 ...
 loadPackage({
  ...
  "package_uuid": "6951c285-4edb-4e27-abe8-ce429117a3a4"
 });
})();
...
var wasmBinaryFile = "ex_mouse.wasm";
